...
function polishCss() {
  return `.split>div{display:grid;grid-template-rows:auto auto 1fr auto;align-content:start}.split>div>.button-link{justify-self:start;margin-top:auto}.split>div p:last-of-type{margin-bottom:18px}.content-section:not(.split){padding-top:24px;padding-bottom:24px}body:not(.page-home):not(.page-guides):not(.seo-report-page) .tool-page,body:not(.page-home):not(.page-guides):not(.seo-report-page) .article-body,body:not(.page-home):not(.page-guides):not(.seo-report-page) .article-search,body:not(.page-home):not(.page-guides):not(.seo-report-page) .content-section{max-width:980px}.tool-page{padding:0 clamp(18px,4vw,52px)}.tool-page .tool-panel{max-width:none}.article-search{padding-top:20px!important;padding-bottom:20px!important;grid-template-columns:minmax(300px,.72fr) minmax(360px,.86fr);align-items:center;gap:28px}.article-search>div{display:grid;gap:9px}.article-search h2{font-family:Inter,Segoe UI,Arial,sans-serif;font-size:clamp(20px,1.55vw,25px);font-weight:680;line-height:1.28;margin:0;letter-spacing:0;max-width:560px}.article-search .eyebrow{width:max-content}.site-search-form{align-items:end;max-width:560px;justify-self:end;width:100%;padding:14px;background:#fffaf3;border:1px solid #eadfcc;border-radius:8px}.site-search-form label{font-size:13px;font-weight:680;color:#312a23}.site-search-form input{height:41px}.site-search-form button{min-height:41px;font-weight:720}.article-body{padding-top:28px!important;padding-bottom:28px!important}.article-body h2{font-family:Inter,Segoe UI,Arial,sans-serif;font-size:clamp(23px,1.9vw,30px);font-weight:700;line-height:1.22;margin:8px 0 14px}.article-body .eyebrow{margin-bottom:8px}.article-body .lead-answer{font-size:17px;line-height:1.72;color:#2f2922}.article-list{margin:12px 0 0;padding-left:20px;color:#463f38}.article-list li{margin:6px 0}.page-home .content-section,.page-guides .content-section{padding:26px clamp(18px,4vw,52px);margin-bottom:28px}.page-home .tool-strip{padding:0;margin-bottom:28px}.page-home .tool-strip .tool-panel{min-height:100%}.page-home .ad-slot{max-width:1160px}.page-guides .article-search{max-width:1160px;grid-template-columns:minmax(520px,1fr) minmax(360px,560px);align-items:center;margin-bottom:32px}.page-guides .site-search-form{max-width:560px;justify-self:end}.page-guides .article-search h2,.page-guides .section-heading h2{font-family:Inter,Segoe UI,Arial,sans-serif;font-size:clamp(22px,1.75vw,27px);font-weight:700;line-height:1.25;letter-spacing:0}.page-guides .article-search h2{max-width:640px}.page-guides .section-heading{margin-bottom:20px}.page-guides .guide-grid{margin-top:2px}.page-guides .guide-next{padding-top:24px;padding-bottom:24px}.page-guides-horse-chinese-zodiac .page-hero h1{font-size:clamp(34px,4vw,50px)}.page-guides-horse-chinese-zodiac .content-section{margin-bottom:24px}@media(max-width:1180px){.article-search,.page-guides .article-search{grid-template-columns:1fr}.article-search h2{max-width:720px}.site-search-form,.page-guides .site-search-form{max-width:100%;justify-self:stretch}}@media(max-width:640px){.site-search-form{grid-template-columns:1fr;padding:12px}.article-search{gap:16px}}`;
}
